...
As systems grow, logs become scattered across services, containers, and servers. Important failures get buried, formats differ, and alerting is inconsistent.
This project introduces a small centralized logging service that any application can call with a simple HTTP request. The service handles routing, storage, and
alerts, keeping client applications clean.
...
```json
{
  ...
  "env": "production",
  "severity": "critical",
  "message": "Payment processing crashed while validating card details",
  "context": {
    "user_id": 77102,
    "order_id": 55931,
    ...
    "service_instance": "payment-service-7f9c6d4b6d-ptx2k"
  },
  "trace": {
    "error_type": "TypeError",
    "error_message": "Cannot read properties of undefined (reading 'expiryDate')",
    "file": "src/controllers/paymentController.js",
    "function": "validateCard",
    "line": 87,
    "column": 23,
    "stack": [
      "validateCard (src/controllers/paymentController.js:87:23)",
      "processPayment (src/services/paymentService.js:142:15)",
      "handleRequest (src/routes/paymentRoutes.js:54:9)"
    ],
    "runtime": "nodejs",
    "timestamp": "2026-02-28T11:42:17.381Z"
  }
}
```
...
Distributed systems require intentional observability. This service shows how a small, focused tool can improve reliability and debugging without increasing
